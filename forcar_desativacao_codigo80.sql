-- =====================================================
-- SCRIPT PARA FORÇAR DESATIVAÇÃO DO CÓDIGO 80
-- =====================================================
-- 
-- ⚠️  ATENÇÃO: Este script vai FORÇAR a desativação de TODOS os produtos código 80
-- para permitir a criação da constraint UNIQUE
--
-- =====================================================

-- 1. VERIFICAR SITUAÇÃO ATUAL DO CÓDIGO 80
SELECT '=== SITUAÇÃO ATUAL DO CÓDIGO 80 ===' as secao;
...
-- 2. CONTAR PRODUTOS CÓDIGO 80 POR STATUS
SELECT '=== CONTAGEM POR STATUS ===' as secao;
...
-- Desativar TODOS os produtos com código 80 (independente do status)
UPDATE public.produtos 
SET 
  status = 'inativo',
  observacoes = COALESCE(observacoes, '') || ' [FORÇADO - Código 80 removido para constraint UNIQUE]',
  updated_at = NOW()
WHERE codigo_pdv = '80';

-- Mostrar quantos produtos foram afetados
SELECT 
  'Produtos código 80 afetados' as resultado,
  COUNT(*) as quantidade
FROM public.produtos 
WHERE codigo_pdv = '80';
...
SELECT '1. Todos os produtos código 80 foram forçadamente desativados' as passo;
